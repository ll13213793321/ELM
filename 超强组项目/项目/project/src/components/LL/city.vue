  ...
  <div id="app">
    ...
    <div>
      <ul class="ul1">
        <li
          :key="i"
          v-for="(v,i) in hotName"
          class="li1"
          @click="hotCitys(i),send(v.id)"
        >{{v.name}}</li>
      </ul>
      <ul>
        <li
          :key="key"
          v-for="(value,key) in allName"
        >
          <div class="head">
          ...
          <ul class="ul1">
            <li
              ...
              v-for="(v,i) in value"
              class="li1 lis"
              @click=" allCitys(i,key),send(v.id)"
            >{{v.name}}</li>
          </ul>
        </li>
      </ul>
...
export default {
  ...
  methods: {
    send(v){
     this.$store.commit("getMessage4",v);
    },
    positionCity() {
