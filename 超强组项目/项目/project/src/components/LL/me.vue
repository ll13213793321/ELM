<template>
  <div id="my">
    ...
    >
      ...
      <img
        id="arrow"
        src="../../../static/imgs1/youjiantou.png"
        alt
      >
    </div>
    <div id="middle1">
    ...
    <div id="middle2">
      <div id="top">
        ...
        <img
          class="picture2"
          src="../../../static/imgs1/iconfontjiantou2.png"
          alt
        >
      </div>
      ...
      <router-link to="/vipcenter">
        <div id="below">
          ...
          <img
            class="picture1"
            src="../../../static/imgs1/huangguan.png"
            alt
          >
