<template>
  <div id="app">
    ...
    <div id="center">
      <p @click="middles(),changeSbcl()">
        <span :class="{span_l:showS==true}">商品</span>
      </p>
      <p @click="centers(),changeSbcR()">
        <span :class="{span_l:showS==false}">评价</span>
      </p>
    </div>
    <div
      id="middle"
        ...
        <div id="content_left">
          <ul class="left">
            <li
              ...
              :key="i"
              id="left_li"
              :class="{left_li1:showLe,left_li2:showLe2==i}"
            ><a
                :href="'#p'+i"
                @click="changeBcL(i)"
              >
            ...
            >
              ...
              <ul class="rightMessage">
                ...
                <li>
                  ...
                  <span
                    class="add"
                    @click="value.is_featured++;v.type++;count++;counts(value.specfoods[0].price, 1),addd(key,$event)"
                  >+</span>
                  <span
                    class="count"
    ...
    >
      <ul>
        <li class="shopCar">
          <span><img src="../../../static/imgs/gouwuche.png"></span>
          <span
            v-if="count>0"
            @click="showCar=!showCar"
          ><img src="../../../static/imgs/gouwuche.png"></span>
          <span
            class="shopCarCount"
            v-if="count>0"
          >{{count}}</span>
        ...
        <router-link :to="'/orderSure?allPrice='+this.allPrice">
          <li class="sureSubmit">
            去结算
          </li>
        </router-link>
  ...
  methods: {
    ...
    getShop() {
      this.$http({
        ...
        this.$store.commit("getMessage2", this.shopArr);
        this.getTalk();
        this.getTalkClass();
        this.getRates();
      });
