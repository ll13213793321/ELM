<template>
  ...
  <transition name="el-fade-in">
    ...
    <div id="search">
      ...
      <span id="clear_value" v-if="clear_val" @click="clear_val1()">x</span>
      <div
        id="Search_mid"
        style="height:0.55rem;background-color:white;"
      >
        <div id="Search_input">
          <input
            @input="add()"
        ...
        <ul v-if="S_r">
          ...
          >
            <router-link to="/shopDetial">
              <div id="kuang" @click="setMessage(v)">
                <img
                  id="Res_img"
                  style="width:0.4rem"
...
export default {
  ...
  created() {
    this.geohash = this.$store.state.Allgeohash;
