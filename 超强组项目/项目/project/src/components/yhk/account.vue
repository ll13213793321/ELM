<template>
  <div id="account">
    ...
    <div id="header">
      ...
      <a @click="back()">
        <img id="backimg" src="../../../static/imgs1/back.png" alt>
      </a>
    </div>
    <!-- 中间部分 -->
    <div id="mid">
      <div id="touxiang">
        ...
        <img id="jiantou1" src="../../../static/imgs1/iconfontjiantou2.png" alt width="5%">
      </div>
      <router-link to="/changename">
        <div id="username">
          <p class="font1">用户名</p>
          <p id="id">{{$store.state.username}}</p>
          <img class="jiantou" src="../../../static/imgs1/iconfontjiantou2.png" alt width="5%">
        </div>
      </router-link>
      ...
      <div @click="show3()" id="phone">
        <img id="imgphone" src="../../../static/imgs1/phone.png" alt width="6%">
        <p class="font2">手机</p>
        <img class="jiantou" src="../../../static/imgs1/iconfontjiantou2.png" alt width="5%">
      </div>
      <p id="zh">安全设置</p>
      <router-link to="/resetPw">
        <div id="pw">
          ...
          <p class="font3">修改</p>
          <img id="jiantou3" src="../../../static/imgs1/iconfontjiantou2.png" alt width="5%">
        </div>
      </router-link>
