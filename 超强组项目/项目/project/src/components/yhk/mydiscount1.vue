  ...
  <div id="mydiscount1">
    ...
    <div id="wz">
      ...
      <router-link to="/hongbaoexplain">
        <p id="wzp2">
          <img src="../../../static/imgs1/wenhao2.png" alt>
          红包说明
        </p>
      </router-link>
    </div>
    ...
    <router-link to="/hongbaohistory">
      <p id="txt2">查看历史红包 <img id="jiantou" src="../../../static/imgs1/iconfontjiantou2.png" alt width="20rem"></p>
    </router-link>
    
    <div id="youhui_bottom">
...
#youhui_bottom span:nth-child(1) {
  border: 0;
}
</style>
